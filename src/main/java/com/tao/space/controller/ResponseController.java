...
import com.tao.space.service.user.dto.UserInsertReq;
...
public class ResponseController {
    ...
    public ResponseResult successD() {
        UserInsertReq userInsertReq = UserInsertReq.builder()
                .username("cboss")
                .phone("15120399390")
                .build();
        return ResponseResult.success("good", userInsertReq);
    }
    ...
    public ResponseResult failD() {
        UserInsertReq userInsertReq = UserInsertReq.builder()
                ...
                .phone("15120399390")
                .build();
        return ResponseResult.fail("失败信息", userInsertReq);
    }
